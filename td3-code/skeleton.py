...
def crackencrypted(database):
    ...
    for i in database:
        ...
        clearpass = decrypt(key,i[1])
        crackeddb.append((i[0],clearpass)) # second argument should contain cleartext password
    return crackeddb
...
def cracksha(database):
    ...
    for i in database:
        ...
        clearpass = getpassfromshahash(hashes, i[1])
        crackeddb.append((i[0],clearpass)) # second argument should contain cleartext password
    return crackeddb
...
def cracksaltedsha(database):
    ...
    for i in database:
        ...
        hashes = []
        for p in passwords:
            hashes.append((salthash(p,salt), p))
        clearpass = getpassfromshahash(hashes, i[1])
        crackeddb.append((i[0],clearpass)) # second argument should contain cleartext password
    return crackeddb
...
def crackpbkdf2(database):
    ...
    for i in database:
        ...
        hashes = []
        for p in passwords:
            hashes.append((pbkdf2(p, i[2], i[3]), p))
        clearpass = getpassfromshahash(hashes, i[1])
        crackeddb.append((i[0],clearpass)) # second argument should contain cleartext password
    return crackeddb
